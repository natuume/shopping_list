...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('.buy-toggle-button').each(function (i, e) {
  var button = jquery__WEBPACK_IMPORTED_MODULE_0___default()(e);
  button.click(function () {
    //ボタンがクリックされたら
    var shopping_list_Id = button.data('shopping_list-id');
    var userId = button.data('user-id');
    var candidateId = button.data('candidate-id');
    var buy = parseInt(button.data('buy'));
    var nextBuy = (buy + 1) % 3;
    jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/shopping_lists/".concat(shopping_list_Id, "/users/").concat(userId, "/candidates/").concat(candidateId), {
      buy: nextBuy
    }, function (data) {
